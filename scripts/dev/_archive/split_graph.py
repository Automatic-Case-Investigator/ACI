...
NAME2MOD = {
    ...
    "AgentState": "state",
    # sanitize
    "_HARMONY_TOKEN_RE": "sanitize",
    "_LEAKED_TOOL_HEADER_RE": "sanitize",
    "_LEAKED_ROLE_LINE_RE": "sanitize",
    "_strip_harmony": "sanitize",
    "_sanitize_message": "sanitize",
    "_sanitize_history": "sanitize",
    "_normalize": "sanitize",
    # parsing
    "_extract_report_section": "parsing",
    "_section_has_concrete_items": "parsing",
    "_NEW_LEADS_HEADER_RE": "parsing",
    "_NEW_LEADS_RE": "parsing",
    "_CONFIRMED_FACTS_RE": "parsing",
    "_HYPOTHESES_RE": "parsing",
    "_TRIAGE_SOAR_ONLY_RE": "parsing",
    "_TRIAGE_EVIDENCE_GAPS_RE": "parsing",
    "_SECTION_HEADER_RE": "parsing",
    "_section_body": "parsing",
    "_FACT_BULLET_RE": "parsing",
    "_NONE_BULLETS": "parsing",
    "_NONE_PREFIXES": "parsing",
    "_is_none_bullet": "parsing",
    "_is_provenance_only": "parsing",
    "_EVENT_ID_TOKEN_RE": "parsing",
    "_event_ids_in": "parsing",
    "_fact_dedup_key": "parsing",
    "_STATUS_TOKEN_RE": "parsing",
    "_ID_MARKER_RE": "parsing",
    "_EMPH_RE": "parsing",
    "_NON_HYPOTHESIS_RE": "parsing",
    "_SOURCE_REF_RE": "parsing",
    "_ISO_TS_RE": "parsing",
    "_CHAR_TRANSLATION": "parsing",
    "_ascii_dashes": "parsing",
    "_EVENT_ID_DUMP_RE": "parsing",
    "_IP_LITERAL_RE": "parsing",
    "_DOMAIN_LITERAL_RE": "parsing",
    "_HASH_LITERAL_RE": "parsing",
    "_PATH_LITERAL_RE": "parsing",
    "_JSON_EVENT_ID_RE": "parsing",
    "_COMMAND_LITERAL_PATTERNS": "parsing",
    "_LONG_HEX_RE": "parsing",
    "_BRUTE_FORCE_RE": "parsing",
    "_REVERSE_SHELL_RE": "parsing",
    "_PERSISTENCE_RE": "parsing",
    "_TROJAN_RE": "parsing",
    "_ANTI_FORENSIC_RE": "parsing",
    "_NEGATED_EVIDENCE_RE": "parsing",
    "_strip_markers": "parsing",
    "_looks_like_lead": "parsing",
    "_extract_source_refs": "parsing",
    "_lines_with_ips": "parsing",
    "_has_positive_pattern": "parsing",
    "_ACTIVE_COMPROMISE_INDICATORS_RE": "parsing",
    "_DANGLING_FACT_RE": "parsing",
    "_normalize_fact_key": "parsing",
    "_section_count": "parsing",
    # toolio
    "_tmap": "toolio",
    "_SEED_TASK_TITLE": "toolio",
    "_GRAPH_MANAGED_TOOLS": "toolio",
    "_MAX_SYNTHESIS_FINDINGS_CHARS": "toolio",
    "_model_tools_for_agent": "toolio",
    "_invoke_bound_model": "toolio",
    "_first_int": "toolio",
    "_extract_input_tokens": "toolio",
    "_should_compact": "toolio",
    "_compact_history": "toolio",
    "_call": "toolio",
    "_emit_node_entry": "toolio",
    "_list_tasks": "toolio",
    "_has_pending_tasks": "toolio",
    "_parse_claimed_task": "toolio",
    "_reclaim_stale_tasks": "toolio",
    "_MAX_TOOL_RESULT_CHARS": "toolio",
    "_cap_tool_result": "toolio",
    "_is_error_tool_result": "toolio",
    "_expand_tilde_args": "toolio",
    "_ensure_parent_dir": "toolio",
    "_cancel_requested": "toolio",
    # board
    "_format_board_context": "board",
    "_record_board_entry": "board",
    "_record_hypotheses_text": "board",
    "_entry_line": "board",
    # validation
    "_collect_escalation_facts": "validation",
    "_artifact_literals_in": "validation",
    "_positive_artifact_literals": "validation",
    "_iter_leaf_strings": "validation",
    "_board_entries_for_validation": "validation",
    "_trusted_artifacts_for_validation": "validation",
    "_artifact_display": "validation",
    "_derive_report_guardrails": "validation",
    # synthesis
    "_execution_record": "synthesis",
    "_build_investigation_summary": "synthesis",
    "_ANALYST_REPORT_SYSTEM": "synthesis",
    "_FINDINGS_RE": "synthesis",
    "_clip_findings_for_synthesis": "synthesis",
    "_task_summary_for_synthesis": "synthesis",
    "_synthesize_analyst_report": "synthesis",
    # nodes_loop
    "seed": "nodes_loop",
    "claim": "nodes_loop",
    "think": "nodes_loop",
    "use_tools": "nodes_loop",
    "_enrich_artifacts_async": "nodes_loop",
    # nodes_flow
    "_MAX_PIVOT_TASKS": "nodes_flow",
    "assess": "nodes_flow",
    "pivot": "nodes_flow",
    "finish": "nodes_flow",
    # builder
    "_route_claim": "builder",
    "_route_use_tools": "builder",
    "_route_think": "builder",
    "_route_assess": "builder",
    "build_graph": "builder",
    "GRAPH": "builder",
}
...
EXT = {
    "emit": "..infra.logbus",
    "src_label": "..infra.logbus",
    "summarize_args": "..infra.logbus",
    "summarize_result": "..infra.logbus",
    "summarize_think": "..infra.logbus",
    "update_context_usage": "..infra.logbus",
    "invoke_streaming": "..engine.streaming",
    "record_artifacts": "..analysis.artifacts",
    "parse_verdict": "..analysis.verdict",
    "apply_citation_policy": "..analysis.verdict",
    "apply_open_gaps_policy": "..analysis.verdict",
    "validate_verdict": "..analysis.verdict",
    "reports_dir": "..infra.avfs",
    "findings_dir": "..infra.avfs",
    "case_dir": "..infra.avfs",
    "home_dir": "..infra.avfs",
    "update_memory_indexes": "...workspace.avfs_writer",
    "write_file": "...workspace.avfs_writer",
    "Handoff": "...agents.base",
    "SystemMessage": "langchain_core.messages",
    "HumanMessage": "langchain_core.messages",
    "ToolMessage": "langchain_core.messages",
