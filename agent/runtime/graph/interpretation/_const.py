...
_CONTINUE_ACTIONS = frozenset(
    {"pivot_entity", "retrieve_specific_event", "profile_window", "refine_query"}
)
...
_DEFAULT_STOP_CONDITION = "Retrieve concrete task-specific evidence or a well-scoped confirmed-negative query."
_REPORT_INSTRUCTION = (
