...
_REVIEW_SYSTEM = (
    ...
    "Distinguish redundant work from unresolved work. Repeating an identical query, chasing "
    "a conclusive completed task, or re-searching an exhausted slice is redundant. An "
    "unqueried timeline candidate, unconfirmed phase, inconclusive negative, or uncovered "
    "artifact pivot is unresolved and must either be worked now or retained as a concrete "
    "New Lead / open hypothesis.\n\n"
