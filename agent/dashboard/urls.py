...
urlpatterns = [
    ...
    path("settings/connection/activate", settings_views.settings_connection_activate, name="settings_connection_activate"),
    path("settings/connection/delete", settings_views.settings_connection_delete, name="settings_connection_delete"),
    ...
    path("settings/response-policy", settings_views.settings_response_policy_save, name="settings_response_policy_save"),
    path("settings/response-policy/reset", settings_views.settings_response_policy_reset, name="settings_response_policy_reset"),
