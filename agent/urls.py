...
urlpatterns = [
    ...
    path(
        "runs/<uuid:run_id>/",
        views.AgentRunDetailView.as_view(),
        name="agent_run_detail",
    ),
    path(
        "runs/<uuid:run_id>/status/",
        views.AgentRunStatusView.as_view(),
    ...
    path(
        ...
        views.AgentRunResumeView.as_view(),
        name="agent_run_resume",
    ),
    path(
        "runs/<uuid:run_id>/restart/",
        views.AgentRunRestartView.as_view(),
        name="agent_run_restart",
    ),
    path(
        "runs/<uuid:run_id>/feedback/",
        views.AgentRunFeedbackView.as_view(),
        name="agent_run_feedback",
    ),
    path(
        "webhooks/thehive/", views.TheHiveWebhookView.as_view(), name="thehive_webhook"
    ),
    path(
        "webhooks/<slug:trigger_id>/",
        views.ConfiguredWebhookView.as_view(),
    ...
    path(
        ...
        views.CaseQueueTasksView.as_view(),
        name="case_queue_tasks",
    ),
    path(
        "cases/<str:case_id>/workspace/",
        views.CaseWorkspaceView.as_view(),
        name="case_workspace",
    ),
    path(
        "cases/<str:case_id>/reports/latest/",
        views.CaseLatestReportView.as_view(),
