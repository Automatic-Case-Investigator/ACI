...
from agent.runtime.analysis.intent import generate_public_intent
from agent.runtime.engine.streaming import invoke_streaming
...
class TestStreaming(unittest.TestCase):
    ...
    def test_empty_intent_emits_no_synthetic_event(self):
        with patch("agent.runtime.analysis.intent.emit") as emit:
            result = asyncio.run(
                generate_public_intent(
                    EmptyIntentModel(),
                    [],
